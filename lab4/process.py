            ...
            for i, line in enumerate(tqdm(lines)):
                ...
                for j, spo in enumerate(spo_list):
                    ...
                    try:
                        ...
                        subject_re_res = [m for m in re.finditer(spo['subject'], text)]
                    ...
                    try:
                        ...
                        object_re_res = object_re_res = [m for m in re.finditer(spo['object']['@value'], text)]
...
if __name__ == "__main__":
    ...
    processDuieData.get_ner_data(processDuieData.train_file,
                                os.path.join(processDuieData.data_path, "train.txt"))
    processDuieData.get_ner_data(processDuieData.dev_file, os.path.join(processDuieData.data_path, "dev.txt"))
